...
<meta http-equiv="Content-Type" content="text/html; UTF-8">
	...
	<script type="text/javascript" src="js/afes/user/userList.js"></script>
...
<body>
	...
	<div class="container" id="tourpackages-carousel">
      <div class="row">
        <div class="col-lg-12"><h1>Users </h1></div>
		<div id="userForm">
        </div>
							...
							<div class="form-group">
								...
								<div class="cols-sm-10">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="name" id="userId" readonly/>
									</div>
								</div>
							</div>
